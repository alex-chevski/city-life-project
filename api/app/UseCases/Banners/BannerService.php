...
class BannerService
{
    ...
    // Robokassa
    // public function generateRedirectUrl($id, $cost, $description){
    // this->setDataRobokassa($id, $cost, $description);
    // return $this->robokassa->getPaymentUrl();
    // }

    // private function setDataRobokassa($id, $cost, $description){
    // $this->robokassa
    // ->setInvoiceId($id)
    // ->setSum($cost)
